...
import 'package:evcp/screen/login/new_password.dart';
...
class _VerificationState extends State<Verification> {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      height: Get.height,
      child: Scaffold(backgroundColor: notifire.getbgcolor10,
              ...
              if (constraints.maxWidth < 600) {
                return Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Center(child: Verifi_cation(constraints.maxWidth)),
                    ],
                  ),
                );
  ...
  Widget Verifi_cation(constraints) {
          ...
          children: [
            Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Image.asset('assets/DeviceMobile-d.png', scale: 5,color: notifire.getblackcolor,),
                    const SizedBox(
                      height: 10,
                    ),
                     Center(
                      child: Text(
                        ...
                        style: TextStyle(
                            ...
                            fontSize: 25,color: notifire.getblackcolor,
                    ...
                    Center(
                      child: Text(
                        ...
                        style:
                        TextStyle(color: notifire.getblackcolor, fontFamily: 'InterRegular'),
                    ...
                    OtpTextField(
                      ...
                      fieldWidth: 36,
                      textStyle:  TextStyle(color: notifire.getblackcolor,),
                      borderColor: notifire.getgrey1,
                      showFieldAsBox: true,
                    ...
                    Row(
                      ...
                      children: [
                        Text('Didn’t get the code ?',
                            style: TextStyle(
                                fontFamily: 'InterRegular', color: grey3)),
                        InkWell(
                          onTap: () {
                        ...
                        Text('or ',
                            style: TextStyle(
                                color: grey3, fontFamily: 'InterRegular')),
                        InkWell(
                          onTap: () {
