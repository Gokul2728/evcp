        ...
        Row(
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),color: greyy,),),
            const SizedBox(width: 10,),
            Text('Customers Grid',style: TextStyle(color: notifire.getblackcolor,fontSize: 14,fontFamily: 'InterRegular'),),
          ],
        ),
                                ...
                                child: StatefulBuilder(builder: (context, setState) {
                                  return Padding(
                                    ...
                                    child: Column(
                                      ...
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      children: [
                                         Text('Add Customer',style: TextStyle(fontSize: 20,fontFamily: 'InterRegular',fontWeight: FontWeight.w500,color:  notifire.getblackcolor,)),
                                        const SizedBox(height: 15,),
                                        Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          mainAxisAlignment: MainAxisAlignment.start,
                                          children: [
                                            const Text('Customer Name',style: TextStyle(fontSize: 12,fontFamily: 'InterRegular',color: Color(0xff727880),fontWeight: FontWeight.w600),),
                                        ...
                                        Column(
                                          ...
                                          mainAxisAlignment: MainAxisAlignment.start,
                                          children: [
                                            const Text('Phone Number',style: TextStyle(fontSize: 12,fontFamily: 'InterRegular',color: Color(0xff727880),fontWeight: FontWeight.w600),),
                                            const SizedBox(height: 5,),
                                            Container(
                                              height: 45,
                                              decoration: BoxDecoration(
                                        ...
                                        Column(
                                          ...
                                          mainAxisAlignment: MainAxisAlignment.start,
                                          children: [
                                            const Text('Email',style: TextStyle(fontSize: 12,fontWeight: FontWeight.w600,fontFamily: 'InterRegular',color: Color(0xff727880)),),
                                            const SizedBox(height: 5,),
                                            Container(
                                              height: 45,
                                              decoration: BoxDecoration(
                                        ...
                                        const SizedBox(height: 10,),
                                        const Text('Join Date',style: TextStyle(fontSize: 12,fontFamily: 'InterRegular',color: Color(0xff727880),fontWeight: FontWeight.w600),),
                                        Row(
                                          children: [
                                            Expanded(
                                              child: Container(
                                        ...
                                        const SizedBox(height: 10,),
                                        const Text('Status',style: TextStyle(fontSize: 12,fontFamily: 'InterRegular',color: Color(0xff727880),fontWeight: FontWeight.w600),),
                                        Row(
                                          children: [
                                            Expanded(
                                          ...
                                          children: [
                                            ...
                                            InkWell(
                                              ...
                                              child: Container(
                                                ...
                                                child: const Center(child: Text('Add Customer',
                ...
                child:  TabBarView(
                        children: [
                          ...
                          GridView.builder(
                            ...
                            itemCount: constraints < 600 ? 10 : 12 ,
                            shrinkWrap: true,
                            itemBuilder: (context, index) {
                              return InkWell(
                                onTap: () {
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        CircleAvatar(
                                          radius: 30,
                                          backgroundImage: AssetImage(model().custom[index]),),

                                        Text(model().custome[index],style:  TextStyle(fontSize: 18,fontFamily: 'InterRegular',color:  notifire.getblackcolor,),),

                                        Text(model().custo[index],style: const TextStyle(fontSize: 14,fontFamily: 'InterRegular',color: Color(0xff727880),),),

                                        Text(model().customs[index],style: const TextStyle(fontSize: 14,fontFamily: 'InterRegular',color: Color(0xff727880)),),
                                        ...
                                        Row(
                                          children: [
                                            Container(
                                              ...
                                              child: Text(model().Active[index],style: TextStyle(fontFamily: 'InterRegular',fontSize: 14,color: model().InterRegular[index])),
                                            ),
                                            const Spacer(),
                                            Image.asset('assets/call.png',height: 16,color: const Color(0xffC6C8CB),),
                                            const SizedBox(width: 20,),
                                            Image.asset('assets/sms.png',height:  16),
                                            const SizedBox(width: 20,),
                                            Image.asset('assets/more.png',height: 16,color: const Color(0xffC6C8CB),)
                                          ],
                                        )
                                      ],
                                    ),
