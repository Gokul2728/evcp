          ...
          Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),color: greyy,),),
              const SizedBox(width: 10,),
              Text('Sellers Grid',style: TextStyle(color: notifire.getblackcolor,fontSize: 14,fontFamily: 'InterRegular'),),
            ],
          ),
          ...
          Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),color: greyy,),),
              const SizedBox(width: 10,),
              Text('Grid',style: TextStyle(color: notifire.getblackcolor,fontSize: 14,fontFamily: 'InterRegular'),),
            ],
          ),
          const SizedBox(height: 20,),
                                  ...
                                  builder: (context, setState) {
                                    return SingleChildScrollView(
                                      child: SizedBox(
                                        height: 500,
                                        child: Theme(
                                          data: ThemeData(canvasColor: notifire.getbgcolor10),
                                          child: Stepper(
                                            elevation: 0,
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  if (_currentStep != 0)
                                                    Container(
                                                      ...
                                                      child: TextButton(
                                                        ...
                                                        child: const Text(
                                                          'Back to Owner',
                                                          style: TextStyle(color: Color(0xff727880),fontSize:
                                                          12,fontFamily: 'InterRegular',fontWeight: FontWeight.w600),
                                                        ),
                                                      ),
                                                    ),
                                                  ...
                                                  InkWell(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: const Center(child: Text('Cancel',style: TextStyle(fontSize: 12,fontWeight: FontWeight.w600,fontFamily: 'InterRegular',color: Color(0xff727880)))),
                                                    ),
                                                  ),
                                                  const SizedBox(width: 10,),
                                                  InkWell(
                                                      onTap: () {
                                                        setState(() {
                                                          if (_currentStep < _steps().length - 3) {
                                                            _currentStep += 3;
                                                      ...
                                                      child: Container(
                                                          ...
                                                          child: const Text('Next',style: TextStyle(fontSize: 12,fontFamily: 'InterRegular',fontWeight: FontWeight.w600,color: Colors.white)))),
                                  ...
                                  child: InkWell(
                                      ...
                                      child: Tab(
                                          child: SvgPicture.asset(
                                            'assets/row-vertical.svg',color:  notifire.getblackcolor,
                                            height: 12,
                                          ))),
                                ),
                                InkWell(
                                  ...
                                  child: Tab(
                                    child: Tab(
                                        child: SvgPicture.asset(
                                          'assets/element-3.svg',color:  notifire.getblackcolor,
                                          height: 12,
                                        )),
                                  ),
                                )
                          ...
                          children: [
                            ...
                            GridView.builder(
                              gridDelegate:  SliverGridDelegateWithFixedCrossAxisCount(
                                crossAxisCount: 1,mainAxisExtent: Get.height / 1.5,
                                crossAxisSpacing: 20,
                                mainAxisSpacing: 20,
                              ),
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Image.asset(model().seller[index],),
                                          ),
                                          const SizedBox(height: 15,),
                                          Text(model().sell[index],style:  TextStyle(fontSize: 18,fontFamily: 'InterRegular',color:  notifire.getblackcolor,),),
                                          const SizedBox(height: 10,),
                                          Image.asset('assets/Rating.png', ),
                                          const SizedBox(height: 15,),
                                          const Text('Created at 18 Nov 2004',style: TextStyle(fontFamily: 'InterRegular',fontSize: 12,color: Color(0xff9DA2A7)),),
                                          const SizedBox(height: 10,),
                                          const Text('Owner by Ananya Ishana',style: TextStyle(fontFamily: 'InterRegular',fontSize: 12,color: Color(0xff9DA2A7)),),
                                          const SizedBox(height: 15,),
                                          Row(
                                            children: [
                                              Expanded(
                                                child: Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    mainAxisAlignment: MainAxisAlignment.start,
                                                    children: [
                                                      Text(model().selll[index],style:  TextStyle(fontSize: 14,fontFamily: 'InterRegular',fontWeight: FontWeight.w600,color:  notifire.getblackcolor,)),
                                                      const SizedBox(height: 15,),
                                                      const Text('Products',style: TextStyle(fontSize: 12,fontFamily: 'InterRegular',color: Color(0xff727880)),)
                                                    ],
                                                  ),
                                                ),
                                              ),
                                              ...
                                              Expanded(
                                                child: Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    mainAxisAlignment: MainAxisAlignment.start,
                                                    children: [
                                                      Text(model().selll1[index],style:  TextStyle(fontSize: 14,fontFamily: 'InterRegular',fontWeight: FontWeight.w600,color:  notifire.getblackcolor,),),
                                                      const SizedBox(height: 15,),
                                                      Row(
                                                        children: [
                                                          const Text('Revenue',style: TextStyle(fontSize: 12,fontFamily: 'InterRegular',color: Color(0xff727880)),),
                                                          const SizedBox(width: 10,),
                                                          Text(model().sellerss[index],style: TextStyle(color: model().selcol[index],fontFamily: 'InterRegular',fontSize: 12,),)
                                                        ],
                                                      )
                                                    ],
                                                  ),
                                            ...
                                            children: [
                                              Expanded(
                                                child: Container(
                                                  ...
                                                  child: const Center(child: Text('See Details',style: TextStyle(color: Color(0xff727880),fontSize: 14,fontFamily: 'InterRegular',fontWeight: FontWeight.w600))),
                                                ),
                                              ),
                                              const SizedBox(width: 10,),
                                              Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          const Text('Export',style: TextStyle(
                              fontSize: 12,
                              fontFamily: 'InterRegular',
                              fontWeight: FontWeight.w600,color: Color(0xff727880)
                          ),)
                        ],
                      ),
                    ),
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Row(children: [
                        Image.asset('assets/add.png', scale: 4),
                        const SizedBox(width: 5,),
                        const Text('Add Seller',style: TextStyle(
                            fontSize: 12,
                            fontFamily: 'InterRegular',
                            fontWeight: FontWeight.w600,
                            color: Colors.white))
              ...
              child: NestedScrollView  (
                  ...
                  body: TabBarView(
                      children: [
                        ...
                        GridView.builder(
                          gridDelegate:  SliverGridDelegateWithFixedCrossAxisCount(
                            crossAxisCount: constraints < 1200 ? 3 : 4 ,mainAxisExtent: Get.height / 1.53,
                            crossAxisSpacing: 20,
                            mainAxisSpacing: 20,
                          ),
                          itemCount: model().sell.length,
